    ...
    */
    ...
    'connections' => [
        ...
        'localdb' => [
            ...
            'database' => env('DB_LOCAL_DATABASE', 'local_db'),
        ...
        'stagingdb' => [
            ...
            'port' => env('DB_STAGE_PORT', '3306'),
            'database' => env('DB_STAGE_DATABASE', 'staging_db'),
            'username' => env('DB_STAGE_USERNAME', 'stage_user'),
        ...
        'proddb' => [
            ...
            'database' => env('DB_PROD_DATABASE', 'prod_db'),
            'username' => env('DB_PROD_USERNAME', 'prod_user'),
